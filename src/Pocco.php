...
namespace Unicodeveloper\Pocco;
...
/**
 * Class Pocco
 * @package Unicodeveloper\Documentarian
 */
class Documentarian
{
    ...
    /**
     * Create a new documentation folder and copy all needed files/stubs
     *
     * @param $folder
     */
    ...
    /**
     * Generate the documentation using the markdown and include files
     *
     * @param $folder
     * @return false|null
     */
